...
## [x] warpfs-graph — tree-sitter parsing and DuckDB graph
- **Priority:** P0 ✅ COMPLETE 2026-06-20
- **Model:** glm-5.2
- **Crate:** warpfs-graph
- **Files:** warpfs-graph/src/lib.rs (17L), warpfs-graph/src/parser.rs, warpfs-graph/src/graph.rs, warpfs-graph/src/duckdb.rs, warpfs-graph/src/error.rs
